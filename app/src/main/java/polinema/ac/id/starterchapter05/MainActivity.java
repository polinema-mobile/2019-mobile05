...
import polinema.ac.id.starterchapter05.activities.DyanamicActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void handlerClickDynamicFragment(View view) {
        Intent intent = new Intent(this, DyanamicActivity.class);
        startActivity(intent);
    }

    public void handlerclickPraktikum(View view) {
    }
}
